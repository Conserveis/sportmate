CREATE DATABASE IF NOT EXISTS `sportmate`
...
CREATE TABLE `Notification` (
  ...
  `Ntype` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `Post` (
  ...
  `PostName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `Status` enum('open','closed','cancelled','finished') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
  PRIMARY KEY (`PostID`),
...
CREATE TABLE `PostType` (
  ...
  `PtypeName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `Review` (
  ...
  `Direction` enum('to_owner','to_participant') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'to_owner',
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trg_review_after_insert` AFTER INSERT ON `Review` FOR EACH ROW BEGIN
    DECLARE v_owner INT;
...
CREATE TABLE `Sport` (
  ...
  `SportName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`SportID`),
...
CREATE TABLE `User` (
  ...
  `OtpCode` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `CreatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `AuthProvider` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'local',
...
INSERT INTO `User` (`UserID`,`UserName`,`Password`,`PhoneNumber`,`Gmail`,`UserTypeID`,`AvgScore`,`IsEmailVerified`,`OtpCode`,`OtpExpireAt`,`FailedLoginCount`,`LockUntil`,`LastActivityAt`,`MembershipExpireAt`,`CreatedAt`,`AuthProvider`,`ProviderId`) VALUES (1,'demo','$2a$10$.Pb8p2kJlOh02rfBZY1jSeQJv2Q1J/OmB5p5bJ23sQEXi0aj25ufm','0800000000','user1@sportmate.test',1,0.00,1,NULL,NULL,0,NULL,NULL,NULL,'2026-07-22 09:48:52','local',NULL),(2,'member','$2a$10$.Pb8p2kJlOh02rfBZY1jSeQJv2Q1J/OmB5p5bJ23sQEXi0aj25ufm','0800000000','user2@sportmate.test',2,0.00,1,NULL,NULL,3,NULL,NULL,'2026-08-22 09:48:52','2026-07-22 09:48:52','local',NULL),(3,'pttrpp',NULL,'0800000000','user3@sportmate.test',1,0.00,1,NULL,NULL,0,NULL,NULL,NULL,'2026-08-25 07:38:06','google',NULL),(4,'สมหญิงเทส',NULL,'0800000000','user4@sportmate.test',1,0.00,1,NULL,NULL,0,NULL,NULL,NULL,'2026-08-25 07:38:39','thaid',NULL),(5,'prae',NULL,'0800000000','user5@sportmate.test',1,0.00,1,NULL,NULL,0,NULL,NULL,NULL,'2026-08-25 11:01:14','google',NULL),(6,'testkun','$2a$10$.Pb8p2kJlOh02rfBZY1jSeQJv2Q1J/OmB5p5bJ23sQEXi0aj25ufm','0800000000','user6@sportmate.test',1,0.00,1,NULL,NULL,0,NULL,NULL,NULL,'2026-08-25 21:54:11','local',NULL),(7,'0432pattarapornprathumsuwan',NULL,'0800000000','user7@sportmate.test',2,0.00,1,NULL,NULL,0,NULL,NULL,'2026-09-30 05:32:52','2026-08-30 05:19:46','google',NULL),(8,'twst','$2a$10$.Pb8p2kJlOh02rfBZY1jSeQJv2Q1J/OmB5p5bJ23sQEXi0aj25ufm','0800000000','user8@sportmate.test',1,0.00,1,NULL,NULL,0,NULL,NULL,NULL,'2026-08-31 06:13:17','local',NULL),(9,'admin','$2a$10$.Pb8p2kJlOh02rfBZY1jSeQJv2Q1J/OmB5p5bJ23sQEXi0aj25ufm',NULL,'admin@sportmate.local',3,0.00,1,NULL,NULL,0,NULL,NULL,NULL,'2026-09-02 16:19:23','local',NULL),(10,'pttrpp2',NULL,NULL,'pattarapornas2119@gmail.com',1,0.00,1,NULL,NULL,0,NULL,NULL,NULL,'2026-09-08 08:23:43','google','111365608985921890151'),(11,'testpass','$2a$10$.Pb8p2kJlOh02rfBZY1jSeQJv2Q1J/OmB5p5bJ23sQEXi0aj25ufm',NULL,'testpass@sportmate.test',1,0.00,1,NULL,NULL,0,NULL,NULL,NULL,'2026-09-08 08:31:23','local',NULL);
...
CREATE TABLE `UserType` (
  ...
  `UTypeName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `UserType` VALUES (3,'Admin'),(2,'Member'),(1,'Normal');
