...
/**
 * ข้อมูลโปรไฟล์สาธารณะของผู้ใช้คนหนึ่ง (UC: ดูโปรไฟล์ผู้จัด / ดูโปรไฟล์ผู้เข้าร่วม)
 *
 * รวมสถิติ 2 ฝั่งไว้ในออบเจ็กต์เดียว เพราะผู้ใช้ 1 คนเป็นได้ทั้งผู้จัดและผู้เข้าร่วม
 *  - ฝั่งผู้จัด    : จำนวนครั้งที่จัด / คะแนนเฉลี่ย / รีวิวที่ได้รับ / กิจกรรมที่เคยจัด
 *  - ฝั่งผู้เข้าร่วม : จำนวนครั้งที่เข้าร่วม / กีฬาที่เข้าร่วมมากที่สุด / กิจกรรมล่าสุด
 *
 * หมายเหตุด้านความเป็นส่วนตัว: ไม่บรรจุอีเมล/เบอร์โทรไว้ในนี้ หน้า public profile
 * จึงไม่มีทางแสดงข้อมูลติดต่อออกไปได้
 */
